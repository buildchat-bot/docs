...
The theme tab allows you to customize the look of your chatbot.

## Global

This section allows you to enable or disable the chatbot branding, change the font and the background of your bot.
