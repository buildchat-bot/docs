...
You can change the font of your chatbot in the Theme tab under the Global section.
...
<Note>
  The server providing the fonts (`https://example.com/awesome.woff`) needs to
