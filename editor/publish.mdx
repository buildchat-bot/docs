...
- "Close chatbot to new responses": close your chatbot and your users will see the following message: "This bot is now closed."
- "Unpublish chatbot": mark the chatbot as unpublished and your users will see the following message: "The bot you're looking for doesn't exist"
