...
Under the hood, buildchatbot always compute all the blocks between each input blocks. But sometimes you may want to display some messages before a long-running action.
