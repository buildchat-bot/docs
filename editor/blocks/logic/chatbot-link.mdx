---
title: Link to chatbot
icon: box
---

The buildchatbot link logic block allows you to go into another buildchatbot flow. This ultimately helps keep your flows clean and be able to reuse a flow in multiple places.
