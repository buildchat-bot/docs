...
Blocks are the atomic building blocks of a chatbot. You can chain any blocks together to create complexe conversation flows. When you drag and drop a block in the chatbot flow, by default it will be inserted into a group that can have a title. Blocks are always contained in groups.
