...
This will allow user to checkbox each choice.

## Dynamic items

Instead of adding items manually, you can also display a dynamic list of items based on a variable.

This is useful when you want to display a list of items from another data source. For this to work, you first need to make sure the variable you are using contains a list of values.
...
Using condition logic you can set what button should be displayed to user under specific condition.
