---
title: Forward UTM parameters to a chatbot
---

The UTM parameter name should be listed in the Variables dropdown of your flow you can create it on any variable dropdown. Then, if your chatbot is launched with the declared UTM parameter. It should appear in the Results tab.
