...
At Build Chatbot, we uphold freedom of speech, but we also recognize our responsibility to keep our platform free from illegal content.

Here are some examples of content that is not allowed on Build Chatbot:
...
This list is not exhaustive. We continually monitor the platform and will take action on content that we determine to violate these restrictions in keeping with the law and our company policies, ensuring that Build Chatbot remains a secure environment for all users.
...
If you feel a chatbot violates our Terms of Service, please report it to us at support@buildchat.bot
