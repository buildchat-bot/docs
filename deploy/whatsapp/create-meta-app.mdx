...
## 1. Create a Facebook Business portfolio

1. Head over to https://business.facebook.com and log in
2. Create a new business portfolio on the left side bar

<Info>
  It is possible that Meta automatically restricts your newly created Business
  portfolio. In that case, make sure to verify your identity to proceed.
</Info>
...
You can then follow the instructions in the Share tab of your bot to connect your Meta app to Chatbot.
